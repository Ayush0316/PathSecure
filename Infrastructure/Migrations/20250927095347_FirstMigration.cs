        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentResourceId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourcePermissions", x => new { x.ResourceId, x.PermissionId });
                    table.ForeignKey(
                        name: "FK_ResourcePermissions_Permissions_PermissionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResourcePermissions_PermissionId",
